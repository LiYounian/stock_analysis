...
THRESHOLD_REGISTRY = [
    ...
    ("电子", "_HI_研发资本化比", 1.5, "开发支出比研发费用", "hi", 1),
    # 计算机
    ("计算机", "_HI_研发资本化比", 2.7, "开发支出比研发费用", "hi", 1),
    # 通信
    ("通信", "_HI_研发资本化比", 1.7, "开发支出比研发费用", "hi", 1),
    # 国防军工
    ("国防军工", "_HI_研发资本化比", 3.5, "开发支出比研发费用", "hi", 1),
    # 汽车
    ("汽车", "_HI_研发资本化比", 4.7, "开发支出比研发费用", "hi", 1),
    # 基础化工
    ...
    ("机械设备", "_HI_研发资本化比", 2.3, "开发支出比研发费用", "hi", 1),
    # 有色金属
    ...
    ("电力设备", "_HI_研发资本化比", 1.7, "开发支出比研发费用", "hi", 1),
]
