...
from tools.strategy import reversal_turnover as _reversal_turnover  # noqa: F401  导入即注册
from tools.strategy import conditional_rank as _conditional_rank  # noqa: F401  导入即注册
